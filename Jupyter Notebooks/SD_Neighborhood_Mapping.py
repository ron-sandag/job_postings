...
# # Turn the ZIP code information into Neighborhoods
...
"91977" : "Spring Valley",
"91978" : "Spring Valley",
    # Tecate Zip Code (for geo location) = 91980
"91980" : "Tecate",
"91987" : "Tecate",
"92003" : "Bonsall",
...
neighborhood_geolocation_mapping = {
...
def find_SD_neighborhood(zip_code):
...
def find_geolocation_ZIP_Code(location):
    for neighborhood, ZIP_Code in neighborhood_geolocation_mapping.items():
        neighborhood_index = location.find(neighborhood)
